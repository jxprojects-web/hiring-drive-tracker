...
-- Safe to skip entirely for a real event. DELETE the rows below (or just
-- don't run this file) before your actual hiring drive — see README.
--
-- Staff/user accounts are NOT seeded here: Supabase Auth users must be
-- created via the dashboard or sign-up flow (see README "Add staff logins"),
-- because auth.users cannot be safely inserted via plain SQL.
-- ============================================================================
...
-- Mark the rejected sample with a stage/reason for realism.
